...
const AddNewFriend = () => {
  return (
    <div className="flex items-center justify-between m-[6.1px] dark:text-white text-black dark:bg-gray-700/70 bg-gray-400/70 dark:hover:bg-gray-700/75 hover:bg-gray-300/75 rounded-full w-3/4 px-2 py-1 duration:150">
